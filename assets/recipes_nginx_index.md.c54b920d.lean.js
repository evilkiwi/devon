...
<span class="token punctuation">}</span>
</code></pre></div><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>Make sure to re-run the <code>devon switch</code> command any time you change these configs to restart NGINX</p></div>__VP_STATIC_END__`,14),p=[o];function c(i,r,l,k,u,d){return a(),s("div",null,p)}var y=n(t,[["render",c]]);export{m as __pageData,y as default};
